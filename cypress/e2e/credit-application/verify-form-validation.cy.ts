...
describe('Verify Form Validation', () => {
  ...
  describe('returns error messages', () => {
    ...
    it('firstName is empty', () => {
      ...
      cy.get('[data-test-id="error-item"]').should('exist')

      cy.get('[data-test-id="error-item"]').should('contain.text', 'Das Feld "Vorname" darf nicht leer sein.')
    })
    ...
    it('lastName is empty', () => {
      ...
      cy.get('[data-test-id="error-item"]').should('contain.text', 'Das Feld "Nachname" darf nicht leer sein.')
    })
    ...
    it('zipCode is empty', () => {
      ...
      cy.get('[data-test-id="error-item"]').should('contain.text', 'Das Feld "Postleitzahl" darf nicht leer sein.')
    })
    ...
    it('occupation is empty', () => {
      ...
      cy.get('[data-test-id="error-item"]')
